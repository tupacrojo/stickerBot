...
client.on('message', async (message) => {
    ...
    if ((isGroups && config.groups) || !isGroups) {
        ...
        if ((message.type == "image" || message.type == "video" || message.type  == "gif") || (message._data.caption == `${config.prefix}sticker`)) {
            client.sendMessage(message.from, "* ⏳ * Ya va...");
            try {
                ...
                client.sendMessage(message.from, media, {
                    ...
                    client.sendMessage(message.from, "* ✅ * Listo corazon!");
                });
            } catch {
                client.sendMessage(message.from, "* ❎ * Algo explotó!");
            }
        ...
        // Image to Sticker (With Reply Image)
            ...
            if (message.hasQuotedMsg && quotedMsg.hasMedia) {
                ...
                client.sendMessage(message.from, "* ❎ * Responde la imagen bobo!");
            }
        ...
        // Claim or change sticker name and sticker author
            ...
            if (message.body.includes('|')) {
                ...
                client.sendMessage(message.from, `*[❎]* poné :\n*${config.prefix}change <nombre> | <autor>*`);
            }
